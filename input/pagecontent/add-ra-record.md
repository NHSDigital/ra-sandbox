...
[Example Transaction: Add condition resources in a Transaction](Bundle-0003-add-condition-transaction-example.html).  
...
[Example Transaction: Additional condition and flag added to previous Transaction](Bundle-0003-add-condition-transaction-example.html).  
