...
* ^expansion.contains[0].system = "https://fhir.hl7.org.uk/England/CodeSystem/RA-ConditionCategory"
* ^expansion.contains[=].code = #encounter-diagnosis
* ^expansion.contains[=].display = "Encounter Diagnosis"
* ^expansion.contains[+].system = "https://fhir.hl7.org.uk/England/CodeSystem/RA-ConditionCategory"
