ValueSet: RA-AdjustmentCategory
...
* ^url = "https://fhir.nhs.uk/England/ValueSet/RA-AdjustmentCategory"
* ^version = "0.1.0"
* ^status = #draft
* ^date = "2024-02-14"
...
* ^expansion.contains[0].system = "https://fhir.nhs.uk/England/CodeSystem/RA-AdjustmentCategory"
* ^expansion.contains[=].code = #001
* ^expansion.contains[=].display = "Communication support"
* ^expansion.contains[+].system = "https://fhir.nhs.uk/England/CodeSystem/RA-AdjustmentCategory"
